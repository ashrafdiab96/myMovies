...
function getMovies () {
    ...
    let u = `https://jsonplaceholder.typicode.com/posts`; // for test
...
function displayMovies () {
    ...
    for (let i = 0; i < data.length; i++) {
        if (data[i].media_type == 'tv') {
            tempTv += `<div class="col-md-4">
                        <div class="tv-card my-4">
                            <a onclick="getDesc(`+ i +`)">
                                ...
                                <div class="tv-desc">
                                    ...
                                    <i class="fas fa-star rate"></i>
                                    <i class="fas fa-star rate"></i>
                                    <h6>First Air Date: `+ data[i].first_air_date +`</h6>
                                </div>
                            </a>
                        </div>
                    </div>`;
    ...
    document.getElementById("contentTv").innerHTML = tempTv;
    pagination();
}
...
function pagination () {
    ...
    document.getElementById("pageNumTv").innerHTML = temp;
}
...
/* Function to show the tv program description in the same page */
function getDesc(i) {
    let temp = "";
    temp += `<div class="col">
            <div class="row movie-detailes">
                ...
                <div class="col-md-6">
                    <a href="tv.html" class="back" title="back"><i class="far fa-arrow-alt-circle-left fa-2x"></i></a>
                    <h2>`+ data[i].name +`</h2>
                    <h6>`+ data[i].vote_average +`</h6>
                    <i class="fas fa-star rate"></i>
                    <i class="fas fa-star rate"></i>
                    ...
                    <i class="fas fa-star rate"></i>
                    <i class="fas fa-star rate"></i>
                    <h6>Release Date: `+ data[i].first_air_date +`</h6>
    ...
    document.getElementById("contentTv").innerHTML = temp;
}